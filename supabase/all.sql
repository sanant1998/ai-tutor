...
--   countries.sql    needs schoolops.sql, which creates the boards and grades tables this seeds — the US curricula and Kindergarten, so lib/syllabus.ts and the database agree on which board codes exist
